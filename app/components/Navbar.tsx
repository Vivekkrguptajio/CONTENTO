    ...
    <>
        ...
        <header className="nav-header">
          <div className="nav-container">
            ...
            <div className="nav-right">
              ...
              >
                {mobileMenuOpen ? (
                  <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#110D0C" strokeWidth="2.2" strokeLinecap="round">
      ...
      >
        <div
          ...
          style={{ paddingTop: bannerVisible && !isCreatorPage ? 104 : 68 }}
        >
